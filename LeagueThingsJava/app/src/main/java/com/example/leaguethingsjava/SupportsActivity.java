...
public class SupportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(Champion champion: ChampionsDataSource.champions){
            if(champion.getRoles().equals("Support"))
                champions.add(champion);
        }

        ChampionAdapter championAdapter = new ChampionAdapter(this,champions,R.color.role_support);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    myMediaPlayer = MediaPlayer.create(SupportsActivity.this, champion.getPhraseId());
