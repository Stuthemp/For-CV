...
public class MidlanersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(Champion champion: ChampionsDataSource.champions){
            if(champion.getRoles().equals("Mid"))
                champions.add(champion);
        }

        ChampionAdapter championAdapter = new ChampionAdapter(this,champions,R.color.role_mid);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    myMediaPlayer = MediaPlayer.create(MidlanersActivity.this, champion.getPhraseId());
