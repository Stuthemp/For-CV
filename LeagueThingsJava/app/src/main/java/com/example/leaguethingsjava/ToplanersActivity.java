...
public class ToplanersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(Champion champion: ChampionsDataSource.champions){
            if(champion.getRoles().equals("Top"))
                champions.add(champion);
        }

        ChampionAdapter championAdapter = new ChampionAdapter(this,champions,R.color.role_top);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    myMediaPlayer = MediaPlayer.create(ToplanersActivity.this, champion.getPhraseId());
